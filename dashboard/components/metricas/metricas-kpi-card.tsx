...
export function KpiCard({ label, valor, variacion, direccionBuena, sub, onClick, loading, sparklineData, valorActual, valorAnterior }: KpiCardProps) {
  ...
  const content = (
    <div
      className="bg-[var(--bg-card,#1a1a1a)] rounded-xl p-4 flex flex-col gap-1.5 border border-[var(--border-subtle,#2a2a2a)] transition-all duration-200 group relative"
