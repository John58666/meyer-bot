...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <aside className="hidden lg:flex fixed left-0 top-[56px] bottom-0 w-[56px] bg-[var(--bg-sidebar)] border-r border-[var(--border-subtle)] flex-col items-center py-3 z-40 overflow-hidden">
