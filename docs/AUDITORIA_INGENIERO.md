...
- Queue mode + PostgreSQL: workers concurrentes con Redis (Fase 1 completada Jul 2026)
...
| **n8n sin queue mode** ~~SQLite default, no Redis~~ | **✅ CORREGIDO Jul 2026:** PostgreSQL + Redis + 1 worker activo. Faltan: PgBouncer, más workers según demanda | ~~ALTA~~ RESUELTO |
...
| Gap | Impacto | Prioridad |
|-----|---------|-----------|
| **Sin backups automáticos** de PostgreSQL | **✅ CORREGIDO Jul 2026:** `backup-meyer.sh` + cron diario a las 3 AM (30 días retención). ~~Pendiente:~~ offsite Backblaze B2 | ~~CRÍTICA~~ RESUELTO |
